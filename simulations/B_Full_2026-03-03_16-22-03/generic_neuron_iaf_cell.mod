TITLE Mod file for component: Component(id=generic_neuron_iaf_cell type=iafActivityCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/i, on: Component(id=generic_neuron_iaf_cell type=iafActivityCell), from synapses; null
